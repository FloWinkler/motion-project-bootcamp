...
const UserFindFriendInfo = (prop) => {
  const [FolowUser, setFollowUser] = useState(
    prop.userInfo.logged_in_user_is_following
  );
  const [addFriend, setAddFriend] = useState(
    prop.userInfo.logged_in_user_sent_fr
  );
  ...
  return (
    <AddFriendUserDiv>
      ...
      <AboutMeInfoP>{prop.userInfo.about_me}</AboutMeInfoP>
      <LikedElementsDiv>
...
//     "username": "Billy",
//     "job": "Coffee drinker",
//     "avatar": "https://motion-team1.propulsion-learn.ch/media-files/schrimp_man_TKoKgA3.jpg",
//     "banner": null,
//     "location": "Zürich",
//     "phone_number": "",
