...
export const GetAll_Post = async (offset) => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/posts/?limit=25&offset=" +
      offset,
    requestOptions
  )
...
export const GetPost_UserId = async (UserId, offset) => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/posts/user/" +
      UserId +
      "/?limit=25&offset=" +
      offset,
    requestOptions
...
export const Post = async () => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/posts/",
    requestOptions
  )
    .then((response) => response.json())
    .then((result) => console.log(result))
...
export const GET_post_search = async (search) => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/posts/?search=" +
      search,
    requestOptions
  )
    .then((response) => response.json())
...
export const Usersfollow = async (userid) => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/followers/toggle-follow/" +
      userid +
      "/",
    requestOptions
  )
...
export const GetUsersFollowing = async () => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/followers/following/",
    requestOptions
  )
    .then((response) => response.json())
    .then((result) => console.log(result))
...
export const GetUsersFollowers = async () => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/followers/followers/",
    requestOptions
  )
    .then((response) => response.json())
    .then((result) => console.log(result))
...
export const SendFriendRequest = async (userid) => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/friends/request/" +
      userid +
      "/",
    requestOptions
  )
...
export const FriendsRequestsStatus = async (type, friend_request_id) => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/friends/requests/" +
      friend_request_id,
    requestOptions
  )
    .then((response) => response.json())
...
export const GetAllAcceptedFriends = async () => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/friends",
    requestOptions
  )
    .then((response) => response.json())
    .then((result) => console.log(result))
...
export const GetAllUsers = async (offset) => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/users/?limit=25&offset=" +
      offset,
    requestOptions
  )
    .then((response) => response.json())
...
export const GETSearchUsers_userid = async (userid) => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/users/" + userid,
    requestOptions
  )
    .then((response) => response.json())
    .then((result) => console.log(result))
...
export const GetUsers_me = async () => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/users/me/",
    requestOptions
  )
    .then((response) => response.json())
    .then((result) => console.log(result))
...
export const GetLikedPosts = async () => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/posts/likes/",
    requestOptions
  )
    .then((response) => response.json())
    .then((result) => console.log(result))
...
export const GetFriendsPosts = async () => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/posts/friends/",
    requestOptions
  )
    .then((response) => response.json())
    .then((result) => console.log(result))
...
export const GetFollowersPosts = async () => {
  ...
  await fetch(
    "https://motion-team1.propulsion-learn.ch/backend/api/social/posts/following/",
    requestOptions
  )
    .then((response) => response.json())
    .then((result) => console.log(result))
