...
const FilteredOwnPosts = (props) => {
  ...
  const GetMyPosts = async (offset) => {
    ...
    await fetch(
      //   "https://motion-team1.propulsion-learn.ch/backend/api/social/posts/me/?limit=25&offset=" +
      //"https://motion-team1.propulsion-learn.ch/backend/api/social/posts/user/2236/?limit=25&offset=" +
