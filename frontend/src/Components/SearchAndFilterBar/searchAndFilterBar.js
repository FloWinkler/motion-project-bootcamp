...
const SearchAndFilterBar = () => {
  ...
  const GetLikedPosts = async () => {
    ...
    myHeaders.append(
      "Authorization",
      "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjc3OTQzOTU1LCJqdGkiOiJkZDlkMjEyYjI1YTM0Y2E4YTlmMjQxYzk4NjUyNzVhNSIsInVzZXJfaWQiOjIyODR9.nQLXzJjnHqNJskQUpu9jr-u3EVuz9NXwqDrr-wTw29c"
    );
  ...
  return (
    <SearchBarContainer>
      <SearchBarWrapper>
        ...
        <ContainerWrapperRight>
          <FilterWrapper>
            <FilterSetter type="button" onClick={handleLoginClick}>
              Liked
            </FilterSetter>
            <FilterSetter type="button" onClick={handleLoginClick2}>
              Friends
            </FilterSetter>
            <FilterSetter type="button" onClick={handleLoginClick3}>
              Follow
            </FilterSetter>
          </FilterWrapper>
        </ContainerWrapperRight>
